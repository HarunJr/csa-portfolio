...
const Borrow: NextPage = () => {
  ...
  // const requestValidator = (lendAssetName: string, borrowAssetName: string) => {
  ...
  //     lenderNftCs: lendAssetName,
  //     borrowersNftCs: borrowAssetName,
  //   };
  ...
  const borrowRequest = async () => {
    ...
    if (lucid) {
      ...
      const txHash = await lucid.newTx()
        ...
        .mintAssets({ [borrowAssetName]: BigInt(1) }, BorrowRedeemer())
  ...
  return (
    <div className="bg-white">
      ...
      <div className="card w-96 bg-base-100 shadow-lg">
        {/* Borrow */}
        <form onSubmit={() => {borrowRequest()}} className="p-4 rounded shadow flex flex-col items-center">
        ...
        <div className="card-body items-center text-center">
          ...
          <div className="card-actions flex-row">
            <button className="btn btn-primary m-5" onClick={() => { borrowRequest() }}> Borrow</button>
